...
(defun m-appendl (y x)
	(cond ((null? y) (error "appendl: Given-First argument is null; Expected-First argument must be an atom"))
	      ((list? y) (error "appendl: Given-First argument is list; Expected-First argument must be an atom"))
	      ((atom? y) (cond ((null? x) (list y))
...
(defun m-appendr (x y)
	(cond ((null? y) (error "appendr: Given-Second argument is null; Expected-Second argument must be an atom"))
              ((list? y) (error "appendr: Given-Second argument is list; Expected-Second argument must be an atom"))
              ((atom? y) (cond ((null? x) (list y))
